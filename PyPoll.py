...
#1. Declare the empty candidate dictionary
candidate_votes = {}
...
for candidate_name in candidate_votes:
    ...
    #To do To do: print out each candidate's name, vote count, and percentage of votes to the terminal.

    #Determine winning vote count and candidate
    #Determine if the votes is greater than the winning count
    if (votes > winning_count) and (vote_percentage > winning_percentage):
        #If true then sen set winning_count = votes and winning percent = vote percentage
        winning_count = votes
